...
model.Zone1Battery_Dis = Set()
model.Zone2Battery_Dis = Set()
model.Zone3Battery_Dis = Set()
model.Zone4Battery_Dis = Set()
model.Zone1Battery_Stor = Set()
model.Zone2Battery_Stor = Set()
model.Zone3Battery_Stor = Set()
model.Zone4Battery_Stor = Set()
...
model.Batteries_Dis = model.Zone1Battery_Dis | model.Zone2Battery_Dis | model.Zone3Battery_Dis | model.Zone4Battery_Dis
model.Batteries_Stor = model.Zone1Battery_Stor | model.Zone2Battery_Stor | model.Zone3Battery_Stor | model.Zone4Battery_Stor
...
#Battery parameters
model.bat_cap = Param(model.Batteries_Stor)
model.bat_SoC = Param(model.Batteries_Stor, within=NonNegativeReals, initialize=0,mutable=True)
model.bat_RoC = Param(model.Batteries_Stor)
model.bat_RoD = Param(model.Batteries_Dis)
model.bat_eff = Param(model.Batteries_Dis)
...
model.bat_discharge = Var(model.Batteries_Dis,model.HH_periods, within=NonNegativeReals,initialize=0)
model.bat_charge = Var(model.Batteries_Stor,model.HH_periods, within=NonNegativeReals,initialize=0)

#Battery Binary Variables
model.bat_dis_on = Var(model.Batteries_Dis,model.HH_periods, within=Binary, initialize=0)
model.bat_charge_on = Var(model.Batteries_Stor,model.HH_periods, within=Binary, initialize=0)
...
def WECC1(model,i):
    ...
    store = sum(model.bat_charge[j,i] for j in model.Zone1Battery_Stor)
    discharge = sum(model.bat_discharge[j,i] for j in model.Zone1Battery_Dis)
...
def WECC2(model,i):
    ...
    store = sum(model.bat_charge[j,i] for j in model.Zone2Battery_Stor)
    discharge = sum(model.bat_discharge[j,i] for j in model.Zone2Battery_Dis)
...
def WECC3(model,i):
    ...
    store = sum(model.bat_charge[j,i] for j in model.Zone3Battery_Stor)
    discharge = sum(model.bat_discharge[j,i] for j in model.Zone3Battery_Dis)
...
def WECC4(model,i):
    ...
    store = sum(model.bat_charge[j,i] for j in model.Zone4Battery_Stor)
    discharge = sum(model.bat_discharge[j,i] for j in model.Zone4Battery_Dis)
...
def Battery1(model,j,i):
    ...
    Cap = model.bat_cap[j]
    return SoC <= Cap
model.BatConstraint1 = Constraint(model.Batteries_Stor,model.hh_periods,rule=Battery1)
...
model.BatConstraint2 = Constraint(model.Batteries_Stor, model.hh_periods, rule=Battery2)
...
model.BatConstraint3 = Constraint(model.Batteries_Stor, model.hh_periods, rule=Battery3)
...
model.BatConstraint4 = Constraint(model.Batteries_Dis, model.hh_periods, rule=Battery4)
...
def Battery5(model,j,i):
    ...
    return On + Off <= 1
model.BatConstraint5 = Constraint(model.Batteries_Stor, model.hh_periods, rule=Battery5)

#Battery parameters
model.bat_cap = Param(model.Batteries_Stor)
model.bat_SoC = Param(model.Batteries_Stor, initialize=0,mutable=True)
model.bat_RoC = Param(model.Batteries_Stor)
model.bat_RoD = Param(model.Batteries_Dis)
model.bat_eff = Param(model.Batteries_Dis)
