...
if(year % 2 == 0):
    CAISO_wind_frac = (sums.loc[(scenario, 'CA', 'WIND', year), 'Capacity']*frac.loc[('CA','WIND'), 'Fraction'] / cap_totals.loc[(scenario,'CA',year), 'Capacity (GW)']) + \
        (sums.loc[(scenario, 'NV', 'WIND', year), 'Capacity']*frac.loc[('NV','WIND'), 'Fraction'] / cap_totals.loc[(scenario,'NV',year), 'Capacity (GW)'])
    
    CAISO_solar_frac = (sums.loc[(scenario, 'CA', 'SOLAR', year), 'Capacity']*frac.loc[('CA','SOLAR'), 'Fraction'] / cap_totals.loc[(scenario,'CA',year), 'Capacity (GW)']) + \
        (sums.loc[(scenario, 'NV', 'SOLAR', year), 'Capacity']*frac.loc[('NV','SOLAR'), 'Fraction'] / cap_totals.loc[(scenario,'NV',year), 'Capacity (GW)'])
    
    CAISO_bat_frac = sums.loc[(scenario, 'CA', 'BATT', year), 'Capacity'] / cap_totals.loc[(scenario,'CA',year), 'Capacity (GW)']
    
    PNW_solar_frac = (sums.loc[(scenario, 'WA', 'SOLAR', year), 'Capacity']*frac.loc[('WA','SOLAR'), 'Fraction'] / cap_totals.loc[(scenario,'WA',year), 'Capacity (GW)']) + \
        (sums.loc[(scenario, 'OR', 'SOLAR', year), 'Capacity']*frac.loc[('OR','SOLAR'), 'Fraction'] / cap_totals.loc[(scenario,'OR',year), 'Capacity (GW)']) + \
        (sums.loc[(scenario, 'ID', 'SOLAR', year), 'Capacity']*frac.loc[('ID','SOLAR'), 'Fraction'] / cap_totals.loc[(scenario,'ID',year), 'Capacity (GW)'])
    
    PNW_wind_frac = (sums.loc[(scenario, 'WA', 'WIND', year), 'Capacity']*frac.loc[('WA','WIND'), 'Fraction'] / cap_totals.loc[(scenario,'WA',year), 'Capacity (GW)']) + \
    (sums.loc[(scenario, 'OR', 'WIND', year), 'Capacity']*frac.loc[('OR','WIND'), 'Fraction'] / cap_totals.loc[(scenario,'OR',year), 'Capacity (GW)']) + \
    (sums.loc[(scenario, 'ID', 'WIND', year), 'Capacity']*frac.loc[('ID','WIND'), 'Fraction'] / cap_totals.loc[(scenario,'ID',year), 'Capacity (GW)'])
    
    PNW_bat_frac = (sums.loc[(scenario, 'WA', 'BATT', year), 'Capacity'] / cap_totals.loc[(scenario,'WA',year), 'Capacity (GW)']) + \
    (sums.loc[(scenario, 'OR', 'BATT', year), 'Capacity'] / cap_totals.loc[(scenario,'OR',year), 'Capacity (GW)'])
